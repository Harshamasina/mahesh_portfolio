      ...
      <div className="section-container">
        ...
        <div className="publications-list">
          <div className="glass-card publication-item stagger-item">
            ...
            <a href="https://esmed.org/MRA/mra/article/view/6224" target="_blank" rel="noopener noreferrer" className="publication-journal-link">
          ...
          <div className="glass-card publication-item stagger-item">
            ...
            <a href="https://esmed.org/MRA/mra/article/view/5709" target="_blank" rel="noopener noreferrer" className="publication-journal-link">
              <div className="publication-journal">
                <BookOpen className="icon-sm" />
                Show Publication
              </div>
          ...
          <div className="glass-card publication-item stagger-item">
            ...
            <a href="https://esmed.org/MRA/mra/article/view/5219" target="_blank" rel="noopener noreferrer" className="publication-journal-link">
              <div className="publication-journal">
                <BookOpen className="icon-sm" />
                Show Publication
              </div>
          ...
          <div className="glass-card publication-item stagger-item">
            ...
            <a href="https://meetings.asco.org/abstracts-presentations/188964" target="_blank" rel="noopener noreferrer" className="publication-journal-link">
              <div className="publication-journal">
                <BookOpen className="icon-sm" />
                Show Publication
              </div>
          ...
          <div className="glass-card publication-item stagger-item">
            ...
            <a href="https://journal.waocp.org/article_28078.html" target="_blank" rel="noopener noreferrer" className="publication-journal-link">
              <div className="publication-journal">
                <BookOpen className="icon-sm" />
                Show Publication
              </div>
          ...
          <div className="glass-card publication-item stagger-item">
            ...
            <a href="https://pubmed.ncbi.nlm.nih.gov/15093672/" target="_blank" rel="noopener noreferrer" className="publication-journal-link">
              <div className="publication-journal">
                <BookOpen className="icon-sm" />
                Show Publication
              </div>
          ...
          <div className="glass-card publication-item stagger-item">
            ...
            <a href="https://pubmed.ncbi.nlm.nih.gov/29147345/" target="_blank" rel="noopener noreferrer" className="publication-journal-link">
              <div className="publication-journal">
                <BookOpen className="icon-sm" />
                Show Publication
              </div>
          ...
          <div className="glass-card publication-item stagger-item">
            ...
            <a href="https://www.hilarispublisher.com/open-access/use-of-loop-mediated-isothermal-amplification-of-dna-for-the-rapid-detection-of-hiv-aids-related-opportunistic-infections-cmv-tb-in-clinical-specimens-2155-6113.1000154.pdf" target="_blank" rel="noopener noreferrer" className="publication-journal-link">
              <div className="publication-journal">
                <BookOpen className="icon-sm" />
                Show Publication
              </div>
          ...
          <div className="glass-card publication-item stagger-item">
            ...
            <a href="http://www.omicsonline.org/1948.../pdfdownload.php?" target="_blank" rel="noopener noreferrer" className="publication-journal-link">
              <div className="publication-journal">
                <BookOpen className="icon-sm" />
                Show Publication
              </div>
